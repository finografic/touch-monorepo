# TODO: Smart Mocked Profile System
...
**Root Cause**: `useDirtyFixFallback` creates static fallback entries instead of dynamic, filter-aware entries.
...
- [x] Replace `useDirtyFixFallback` with `useSmartFallback`
...
**Next Steps**: Implement `useSmartFallback` hook with temperature profile generation logic
