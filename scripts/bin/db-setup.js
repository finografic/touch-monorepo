...
var loadSeedConfig = async ({ configFileGlob = PATH_FILES_CONFIG } = {}) => {
...
var validateDependencies = ({ seedOrder, selectedSchemas }) => {
  const missing = [];
...
var getSortedSchemas = ({ seedOrder, selectedSchemas }) => {
  const result = [];
