...
export default defineConfig({
  entry: {
    ...
    'messages/app/index': 'src/messages/app/index.ts',
    'messages/app/messages.en-GB': 'src/messages/app/messages.en-GB.ts',
    'messages/app/messages.es-ES': 'src/messages/app/messages.es-ES.ts',
    'messages/app/messages.ca-ES': 'src/messages/app/messages.ca-ES.ts',
