...
export const OrdersForm: React.FC<OrdersFormProps> = ({
  ...
  const methods = useForm<OrdersFormValues>({
    ...
    defaultValues: {
      ...
      timeRows: (() => {
        const existingProfiles = isEditMode && orderData?.temperatureProfiles?.length
  ...
  function handleFieldChange(
    fieldName: string,
    value: any,
    allFormValues: MiddlewareOrdersFormValues,
  ) {
                  ...
                  <Col xs={5} md={5} className="col col-form-fields">
                    ...
                    >
                      <SelectSearchable
                        ...
                        onAddNew={(value) => handleSimpleFieldChange('drinkSubtype', value)}
                        onClear={() => handleSimpleFieldChange('drinkSubtype', '')}
                        options={dropdownData.drinkSubtypeOptions}
                        placeholder={formValues.drinkType
                          ? dropdownData.selectedDrinkType?.hasSubtypes
                  ...
                  <Col xs={2} md={2} className="col col-form-fields col-temperature-inputs">
                    ...
                    <FieldBox name="defaultTempFreeze" label="Temperatura congelación" required>
                      <TemperatureInputField
                        ...
                        locale={currentLanguage}
                        max={formValues.defaultTempConsume
