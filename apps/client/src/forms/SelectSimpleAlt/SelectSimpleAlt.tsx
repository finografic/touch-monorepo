...
import { styles } from './SelectSimpleAlt.styles';

interface SelectSimpleAltProps {
...
export const SelectSimpleAlt = forwardRef<HTMLSelectElement, SelectSimpleAltProps>(
  (
    {
      options,
      value,
...
SelectSimpleAlt.displayName = 'SelectSimpleAlt';
