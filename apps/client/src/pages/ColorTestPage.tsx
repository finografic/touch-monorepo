...
import { useColors, useColorTheme } from 'styles';
  ...
  return (
    <div css={pageStyles}>
      ...
      <div css={cardStyles}>
        ...
        <div>
          <button css={buttonStyles(colors.primaryLight, colors.white)}>Primary Button</button>
          <button css={buttonStyles(colors.successLight, colors.white)}>Success Button</button>
          <button css={buttonStyles(colors.warningLight, colors.white)}>Warning Button</button>
          <button css={buttonStyles(colors.dangerLight, colors.white)}>Danger Button</button>
          <button css={buttonStyles(colors.infoLight, colors.white)}>Info Button</button>
        </div>
      </div>
